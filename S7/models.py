...
class Model3(nn.Module):
    def __init__(self):
        ...
        self.block1 = nn.Sequential(
            nn.Conv2d(1, 10, 3), nn.BatchNorm2d(10), nn.Dropout(0.2)
        )

        self.block2 = nn.Sequential(
            nn.Conv2d(10, 16, 3), nn.BatchNorm2d(16), nn.Dropout(0.2)
        )
        self.transition_block1 = nn.Conv2d(16, 18, 1)
        self.pool1 = nn.MaxPool2d(2, 2)

        self.block3 = nn.Sequential(
            nn.Conv2d(18, 8, 3), nn.BatchNorm2d(8), nn.Dropout(0.2)
        )

        self.block4 = nn.Sequential(
            nn.Conv2d(8, 10, 3), nn.BatchNorm2d(10), nn.Dropout(0.2)
        )
