...
class Model5(nn.Module):
    def __init__(self):
        ...
        self.block1 = nn.Sequential(
            nn.Conv2d(1, 16, 3), nn.ReLU(), nn.BatchNorm2d(16), nn.Dropout(0.25)
        )

        self.block2 = nn.Sequential(
            nn.Conv2d(16, 12, 3), nn.ReLU(), nn.BatchNorm2d(12), nn.Dropout(0.25)
        )
        ...
        self.block3 = nn.Sequential(
            nn.Conv2d(24, 12, 3), nn.ReLU(), nn.BatchNorm2d(12), nn.Dropout(0.25)
        )

        self.block4 = nn.Sequential(
            nn.Conv2d(12, 14, 3), nn.ReLU(), nn.BatchNorm2d(14), nn.Dropout(0.25)
        )
