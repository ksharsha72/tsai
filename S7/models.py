...
class Model1(nn.Module):
    def __init__(self):
        ...
        self.block1 = nn.Sequential(
            nn.Conv2d(1, 14, 3), nn.BatchNorm2d(14), nn.Dropout(0.1)
        )

        self.block2 = nn.Sequential(
            nn.Conv2d(14, 10, 3), nn.BatchNorm2d(10), nn.Dropout(0.1)
        )
        self.transition_block1 = nn.Conv2d(10, 8, 1)
        self.pool1 = nn.MaxPool2d(2, 2)

        self.block3 = nn.Sequential(
            nn.Conv2d(8, 12, 3), nn.BatchNorm2d(12), nn.Dropout(0.1)
        )
        self.block4 = nn.Conv2d(12, 10, 3)
        self.block5 = nn.Conv2d(10, 10, 1)
    ...
    def forward(self, x):
        ...
        x = F.relu(self.block5(F.relu(self.block4(x))))
        x = x.view(-1, 10)
...
class Model3(nn.Module):
    def __init__(self):
        ...
        self.block1 = nn.Sequential(
            nn.Conv2d(1, 14, 3), nn.BatchNorm2d(14), nn.Dropout(0.15)
        )

        self.block2 = nn.Sequential(
            nn.Conv2d(14, 12, 3), nn.BatchNorm2d(12), nn.Dropout(0.15)
        )
        self.transition_block1 = nn.Conv2d(12, 10, 1)
        self.pool1 = nn.MaxPool2d(2, 2)

        self.block3 = nn.Sequential(
            nn.Conv2d(10, 12, 3), nn.BatchNorm2d(12), nn.Dropout(0.15)
        )

        self.block4 = nn.Sequential(
            nn.Conv2d(12, 10, 3), nn.BatchNorm2d(10), nn.Dropout(0.15)
        )

        self.block5 = nn.Conv2d(10, 10, 3)
